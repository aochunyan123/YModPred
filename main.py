...
from model import YModPred_model
...
if __name__ == '__main__':
    ...
    print("Model loading......")
    model = YModPred_model.YModPred().to(device)
    model.load_state_dict(torch.load("./data/m6A_model.pkl", map_location=torch.device(device)))
    print("Predicting......")
